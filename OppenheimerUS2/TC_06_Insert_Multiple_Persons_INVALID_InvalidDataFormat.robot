...
*** Test Cases ***
TC_06:Insert_Multiple_Persons_INVALID_InvalidDataFormat
    [Tags]  Functional
    Create Session    session    ${base_url}
    ${list}=    Create List
    ${body1}=    Create Dictionary   birthday=19950617    gender=M   name=Lewies     natid=s12345678h     salary=4000     tax=400
